...
namespace Uri1094
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Percentual de coelhos : "+vc.ToString("F2", CultureInfo.InvariantCulture)+" %");
            Console.WriteLine("Percentual de ratos : " + vr.ToString("F2", CultureInfo.InvariantCulture) + " %");
            Console.WriteLine("Percentual de sapos : " + vs.ToString("F2", CultureInfo.InvariantCulture) + " %");
